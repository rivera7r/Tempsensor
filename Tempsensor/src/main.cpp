...
// WIFI Credentials
#define WIFI_NAME "Avocado Stealers"
#define WIFI_PASSWORD "bwt7nnpqQnnh"
...
void loop()
{
  ...
  double tempF = tempC * 9 / 5 + 32;                                    //calculate temperature (Farenheit)
  ...
  Serial.printf("Calibration: %d  \tTemperature in C: %.2fC  \tTemperature in F: %.2fF\n", calibrationTime, tempC, tempF);
  delay(1000);
